public class Solution {
    ...
    Map<String, Boolean> getPrefixSet(List<String> words) {
    ...
    void dfs(char[][] board, boolean[][] visited, int x, int y, String word,
             Map<String, Boolean> prefixIsWord, Set<String> wordSet) {
